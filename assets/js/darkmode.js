 ...
 (function () {
  ...
  function updateToggleButton(isDark) {
   ...
   if (toggleBtn) {
    ...
    if (isDark) {
     ...
     toggleBtn.innerHTML =
      '<i class="fas fa-sun" aria-hidden="true"></i><span class="label">Modo Claro</span>';
  ...
  function createToggleButton() {
   ...
   if (window.innerWidth >= 768 && desktopIcons) {
    ...
    if (
     desktopNavIconsStyle &&
     desktopNavIconsStyle.display !== 'none' &&
   ...
   const existingButtons = iconsContainer.querySelectorAll(
